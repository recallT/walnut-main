...
class TestDefectSolverDistribute(Checker):

    @story(f'T151211 缺陷分析-缺陷解决者分布报表：默认报表配置')
    def test_defect_solver_distribute_default_config(self, add_project, _report_key, _filter_config):
